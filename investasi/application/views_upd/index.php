...
<title>:: Portal Investasi Kota Makasar ::</title>
...
<link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400|Titillium+Web:400,200,300' rel='stylesheet' type='text/css'>
	...
	<div id="menu">
		...
		<div style="float:right;padding-top:9px;">
			<form action="<?=base_url()?>cari" method="post">
				<input type="text" name="key" value="" style="height:19px;width:110px;font-size:12px;border:1px solid #ccc;color:#999;background-color:#a13232;color:#deafaf;border:1px solid #ae5757">
				<input type="submit" value="Search" class="btn">
			</form>
		</div>
	</div>
</div>
<?php if($type != 'forum' && $type != 'cari_konten'){?>
...
<div id="wrapper">
	...
	<div class="title">Kepala Dinas</div>
		<div><center><img src="<?=base_url()?>assets/jokowi.jpg" height="200px" style="border: 1px solid #DDD;border-radius: 5px;box-shadow: 0px 0px 5px #DDD;" /></div>
	<br /><br />
	...
	<ul id="ticker_02" class="ticker">
		...
		?>
		<li>
			<a href="<?=base_url()?>berita/<?=$v['id']?>/<?=$linknya?>"><img src="<?=base_url()?>repository/foto/berita/<?=$v['gambar']?>" class="thumb" width="31" height="31"><?=$v['judul_berita']?></a>
		</li>
		<? }?>
		<!--li>
	...
	</ul><div style="margin-top:5px;"><a href="#">Berita lainnya</a></div>
	</div>
...
<div id="container_footer">
	<div id="footer">
		<a href="">Home</a><img src="<?=base_url()?>assets/images/line_menu.png" class="space" />
		<a href="">Profil Dinas</a><img src="<?=base_url()?>assets/images/line_menu.png" class="space" />
		<a href="">Potensi</a><img src="<?=base_url()?>assets/images/line_menu.png" class="space" />
		<a href="">Infrastruktur</a><img src="<?=base_url()?>assets/images/line_menu.png" class="space" />
		<a href="">Perizinan</a><img src="<?=base_url()?>assets/images/line_menu.png" class="space" />
		<a href="">Download</a><img src="<?=base_url()?>assets/images/line_menu.png" class="space" />
		<a href="">Kontak</a><img src="<?=base_url()?>assets/images/line_menu.png" class="space" />
		<a href="">Forum</a>
		<br />
		<br />
		<br />
