<?php
$xbase_url = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http");
$xbase_url .= "://".$_SERVER['HTTP_HOST'];
...
//$root_path = $xbase_url.'assets/filemanager'; //yanto					//path from webroot, without trailing slash. If your page is located in http://www.example.com/john/, this should be '/john'
$file_root = '../../repository'; 		//where to store files, must be created and writable
$root_path = rtrim($xbase_url, "/"); //yanto					//path from webroot, without trailing slash. If your page is located in http://www.example.com/john/, this should be '/john'
...
<head>
  ...
  <script type="text/javascript" src="<?=$xbase_url?>../tinymce/tiny_mce_popup.js"></script>
