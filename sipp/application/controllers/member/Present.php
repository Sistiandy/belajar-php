...
class Present extends CI_Controller {
    ...
    public function index($ket = 'all', $offset = NULL)
    {
        ...
        $data['hadir'] = count($this->Present_model->get(array('desc' => 'Hadir')));
        $data['sakit'] = count($this->Present_model->get(array('desc' => 'Sakit')));
        $data['izin'] = count($this->Present_model->get(array('desc' => 'Izin')));
        $data['alfa'] = count($this->Present_model->get(array('desc' => 'Alfa')));
        $data['semua'] = count($this->Present_model->get());
