   ...
   .small { font-variant:   small-caps; }
    ...
    <div style="padding:0px 0px;">
          ...
          0<?php echo substr($member['member_nip'],3) ?>/SAT-HRA/CLS2/<?php echo pretty_date(date('Y-m-d'), 'm',false)?>/<?php echo pretty_date(date('Y-m-d'), 'Y',false)?>              </p>
             ...
             <table border="0">
                <tbody>
                    <tr>
                        ...
                        <td width="11">:</td>
                        <td width="524"> <span class="upper"><?php echo $member['member_full_name'] ?></span></td>
                    </tr>
                    <tr>
                        <td>Asal Sekolah</td>
                        <td>:</td>
            ...
            <br>
            <p align="justify">Bahwa yang bersangkutan telah melaksanakan kegiatan magang kerja di PT. Sumber Alfaria Trijaya, Tbk magang kerja tersebut telah dilaksanakan selama 3 bulan, yaitu mulai tanggal <?php echo pretty_date( $member['member_input_date'],'d F Y',false) ?> s/d tanggal <?php echo pretty_date( $member['member_last_update'],'d F Y',false) ?>.</p>
