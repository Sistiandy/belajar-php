...
<div class="col-md-12 col-sm-12 col-xs-12 main post-inherit">
    <div class="x_panel post-inherit">
        <div class="col-lg-12">
            <h3><?php echo $operation ?> Peserta</h3>
            <br>
        </div>
        <!-- /.col-lg-12 -->
        ...
        <div class="col-md-12">
            <div class="col-sm-12 col-md-9">
                ...
                <input name="username" type="text" <?php echo (isset($member)) ? 'readonly' : '' ?> placeholder="Username" class="form-control" value="<?php echo $inputUserName; ?>"><br>
                <?php if (!isset($member)): ?>
